 ...
 // Get references to the form inputs and the summary elements
 ...
 // Function to update all summary elements
 function updateSummary() {
   const destination = destinationInput.value || "Bangkok";
   // 格式化日期 (使用自訂格式，確保顯示 "17 June")
   const checkInDate = checkInDateInput.value ? new Date(checkInDateInput.value).toLocaleDateString("zh-TW", { day: '2-digit', month: 'short' }) : "17 Jun";
   const checkOutDate = checkOutDateInput.value ? new Date(checkOutDateInput.value).toLocaleDateString("zh-TW", { day: '2-digit', month: 'short' }) : "19 June";
